...
import com.drcarter.concatadaptertest.viewholder.FruitItemViewHolder

class FruitAdapter(private val items: MutableList<String> = mutableListOf()) :
    RecyclerView.Adapter<FruitItemViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FruitItemViewHolder =
        FruitItemViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.viewholder_fruit_item, parent, false)
        )
